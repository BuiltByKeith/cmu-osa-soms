<div class="modal fade" id="addNewOperationalExpensesModal" tabindex="-1" role="dialog" aria-labelledby="addNewOperationalExpensesModal" Label
    aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header bg-yellow">
                <h4 class="modal-title">Add New Operational Expenses</h4>
            ...
            <div class="modal-body">
                <div class="container">
                    <form action="{{ route('studentOrgAddNewOperationalExpenses') }}" method="POST" enctype="multipart/form-data"
                        class="activityForm">
                        @csrf
